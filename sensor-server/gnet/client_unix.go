...
import (
	...
	"github.com/jurgen-kluft/go-home/sensor-server/gnet/pkg/buffer/ring"
	errorx "github.com/jurgen-kluft/go-home/sensor-server/gnet/pkg/errors"
	"github.com/jurgen-kluft/go-home/sensor-server/gnet/pkg/logging"
	"github.com/jurgen-kluft/go-home/sensor-server/gnet/pkg/math"
...
func NewClient(eh EventHandler, opts ...Option) (cli *Client, err error) {
	...
	if options.Logger == nil {
		if options.LogPath != "" {
			logger, logFlusher, _ = logging.CreateLoggerAsLocalFile(options.LogLevel)
		}
