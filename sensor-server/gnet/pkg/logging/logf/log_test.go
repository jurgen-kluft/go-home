...
func TestLogFormat(t *testing.T) {
	...
	// Log with field.
	l.Warnf("testing fields", "stack", "testing")
	...
	l.Errorf("testing error", "error", fakeErr)
...
func TestLogFormatWithDefaultFields(t *testing.T) {
	...
	l.Infof("hello world", "component", "logf")
...
func TestWriteQuotedStringCases(t *testing.T) {
	...
	for _, d := range data {
		l.Infof("hello world", d.key, d.value)
...
func TestOddNumberedFields(t *testing.T) {
	...
	l.Infof("hello world", "key1", "val1", "key2")
...
func genLogs(l Logger) {
	for i := 0; i < 100; i++ {
		l.Infof("random log", "index", strconv.FormatInt(int64(i), 10))
	}
}
